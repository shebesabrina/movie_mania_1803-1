...
describe 'User Genre show page' do
  it 'displays the movies for each genre' do
    ...
    movie_1 = director.movies.create!(title:'Star Wars Episode 4', description: 'A New Hope')
    movie_2 = director.movies.create!(title:'Star Wars Episode 3', description: 'Return of the Jedi')
